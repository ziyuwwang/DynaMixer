...
'''Tranfer pretrained dynamixer to downstream dataset: CIFAR10/CIFAR100.'''
import torch
...
from models.utils import load_for_transfer_learning
...
if args.transfer_learning:
    print('transfer learning, load DynaMixer pretrained model')
...
# set optimizer
if args.transfer_learning:
    print('set different lr for the DynaMixer module, backbone and classifier(head) of DynaMixer')
    parameters = [{'params': net.module.patch_embed.parameters(), 'lr': args.transfer_ratio * args.lr},
                  {'params': net.module.network.parameters(), 'lr': args.transfer_ratio * args.lr},
